...
execute if score #continue stellarity.misc matches 1.. as @a[tag=stellarity.book_of_return.teleport] run function stellarity:items/spellbooks/return/teleport/teleport_player
